...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CrNQfLTu.js
var router_CrNQfLTu_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-D3Ry4-Ae.css";
var APP_NAME = "HVEN Space POS";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "POS kasir, dapur, absensi, dan pembukuan HVEN Space."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DdcAVB-y.mjs");
...
//#endregion
export { getRouter, router_CrNQfLTu_exports as t };
